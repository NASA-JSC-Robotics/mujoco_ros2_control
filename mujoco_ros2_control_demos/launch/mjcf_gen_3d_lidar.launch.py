...
def launch_setup(context, *args, **kwargs):
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution([pkg_share, "demo_resources", "robot", "3d_lidar_robot.urdf"]),
            " use_pid:=",
        ...
        nodes.append(
            Node(
                ...
                arguments=[
                    ...
                    "--m",
                    PathJoinSubstitution([pkg_share, "demo_resources", "mjcf_generation", "3d_lidar_inputs.xml"]),
                    "--scene",
